# -*- coding: utf-8 -*-
"""
Created on Sun Jul 12 16:41:49 2020
...
A partir deste arquivo, você deve criar um programa que gere um relatório, chamado 
...
#Criando o arquivo usuarios.txt, que é a base do programa
arq = open('usuarios2.txt', 'w+')
